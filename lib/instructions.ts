...
const base=`Patient: ${patients.name}, ${patients.age}${patients.gender}\nChief Complaint: ${patients.chief}\nPHQ-9: ${patients.phq9.score}/27 (${patients.phq9.label}) — SI Item: ${patients.phq9.si}/3\nGAD-7: ${patients.gad7.score}/21 (${patients.gad7.label})\nMedications: ${patients.meds.join(", ")}\nAllergies: ${patients.allergies}\nSubstance Use: ${patients.substance}\nTrauma Hx: ${patients.trauma}\nPrior Treatment: ${patients.priorTx}\nSocial Support: ${patients.support}\nSMI Diagnosis: ${patients.smi||"None"}\nSuicide Attempt Hx: ${patients.hxAttempt?patients.attemptDetail:"None"}\nActive SI: ${patients.activeSI?"Yes":"No"}\nHard Stops: ${patients.hardStops.length?patients.hardStops.map(h=>h.code).join(", "):"None"}`;
